<template>
    <div id="nav">
        <nav :class="{ nav: fixed }" class="fixed top-0 flex w-full px-8 py-4 z-50 bg-transparent md:px-12 lg:px-16 xl:px-20 hover:bg-white transition-colors duration-500">
